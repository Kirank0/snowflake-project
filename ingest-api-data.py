...
def snowpark_basic_auth() -> Session:
    connection_parameters = {
       "ACCOUNT":"flc13068.us-east-1",
        "USER":"SAIKIRANK",
        "PASSWORD":"Kiran@sigmoid9",
        "ROLE":"SYSADMIN",
        "DATABASE":"dev_db",
        "SCHEMA":"stage_sch",
        "WAREHOUSE":"load_wh"
...
def get_air_quality_data(api_key, limit):
    ...
    params = {
        'api-key': '579b464db66ec23bdd000001af76ddb708bb4762450954d69665c406',
        'format': 'json',
        'limit': limit
    }
...
api_key = '579b464db66ec23bdd000001af76ddb708bb4762450954d69665c406'
